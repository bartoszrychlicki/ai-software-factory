...
| `LINEAR_PROJECTS` | comma-separated project keys; if absent, `LINEAR_PROJECT` is used, if both are absent all configured projects are exposed, and an explicitly empty selected variable exposes none (fail-closed) |
